...
public class WeatherToTime {
    ...
    String categoryName[] = {"POP","PTY","R06","REH","SO6","SKY","T3H","TMN","TMX","UUU","VVV","WAV","VEC","WSD"};
    String categoryValue[] = {"","","","","","","","","","","","","",""}; // 최종 결과값임
    String categoryChangeVal[] = {"","","","","","","","","","","","","",""};
    boolean categoryCheck[] = {false,false,false,false,false,false,false,false,false,false,false,false,false,false};
    //온도 날씨만
